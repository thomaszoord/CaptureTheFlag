package br.com.thomaszoord.sccapturetheflag.Commands;
...
public class CTFCommands implements CommandExecutor {
    ...
    private final String prefix = SCCaptureTheFlag.prefix;
    private final String minigames = SCCaptureTheFlag.minigame;
    ...
    private void handleCriarArenaCommand(Player p) {
        ...
        try {
            ...
            config.save(new File(SCCaptureTheFlag.plugin.getDataFolder(), "arenas/" + p.getWorld().getName() + ".yml"));
        } catch (IOException e) {
